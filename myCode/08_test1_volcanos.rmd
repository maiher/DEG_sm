---
title: "Volcano plots - SAMHD1 mouseGL261 Round2 - Test1: off_target_control vs. SAMHD1_KO vs. WT"
author: Maike
...
conFiles <- c('/data2/240409_RKoenig_mouseGL261_round2/240411_DESeq2/240411_Test1_DESeq2_Off_target_control_vs_WT.csv',
...
# loop:
for(i in 1:length(cons)) {
  plotOut <- paste0('240411_Test1_volcano_l2FCTH1_', cons[i], '.pdf')
  print(plotOut)
